  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex min-h-[70vh] flex-col items-center justify-start pt-4 md:justify-center md:pt-0">
        ...
        <div className="mb-12 flex flex-col items-center justify-center gap-2 text-base md:mb-16 md:flex-row md:gap-8 md:text-lg">
          {/* Frontend version */}
          <div className="flex items-center gap-2">
            <span className="text-muted-foreground">{t('about.frontendVersion')}</span>
            <span className="text-foreground font-mono font-semibold">
              {appVersion || t('about.unavailable')}
            </span>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-foreground font-mono font-semibold">
              {commitSha ? commitSha.substring(0, 7) : t('about.unavailable')}
            </span>
            {commitSha ? (
              <a
                href={`https://github.com/raids-lab/crater-frontend/commit/${commitSha}`}
                target="_blank"
