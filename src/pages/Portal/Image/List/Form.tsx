...
const formSchema = z.object({
  ...
  registryServer: z.string().min(1, { message: "镜像仓库地址不能为空" }),
  registryUser: z.string().min(1, { message: "镜像仓库账户不能为空" }),
  registryPass: z.string().min(1, { message: "镜像仓库密码不能为空" }),
  registryProject: z.string().min(1, { message: "镜像仓库项目不能为空" }),
